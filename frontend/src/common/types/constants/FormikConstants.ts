export const MARGIN_DEFAULT_FILTER_FIELDS = {
    DURATION_INTERVAL: { fieldTitle: 'Duration/Interval', objectTitle: 'durationOrInterval', placeholder: 'Select Duration', fieldType: 'text' },
